...
class Settings(BaseSettings):
    ...
    # --- Inbound auth: a random static key (e.g. a UUID) generated by the
    # operator, not tied to any provider. Clients must send it in the
    # X-API-Key header on protected routes (see api/security.py). Fails
    # closed if unset -- an unconfigured key rejects every request. ---
